...
sleep 125
for i in {1..50}; do
    sudo timeout 220 tcpreplay --intf1=ens1f0 --pps=37500 --loop=0 attack_quic_optimistic_ack_5M.pcap &
done
...
cd /local/dpdk_100g/quic
sleep 125
for i in {1..50}; do sudo timeout 220 tcpreplay --intf1=ens1f0 --pps=37500 --loop=0 attack_quic_optimistic_ack_5M.pcap & done
```
