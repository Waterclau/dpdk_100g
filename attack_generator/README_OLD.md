...
Modular and efficient PCAP file generator for DDoS attack simulation, designed for defensive analysis, ML model training, and controlled environment experiments (CloudLab, DPDK, OctoSketch).
