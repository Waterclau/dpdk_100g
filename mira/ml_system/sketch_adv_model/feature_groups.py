#!/usr/bin/env python3
"""
Sketch-ADV Feature Definitions

14 base features from OctoSketch multi-scale + Ring Buffer temporal analysis.
+ 50 SKETCH-ADV features (48 per-protocol + 2 packet size).
Total: 64 features when --sketch-adv is enabled.

This is the same as sketch_model/feature_groups.py but kept here
for self-contained imports within sketch_adv_model.
"""
...
# Per-protocol sketch features (4 features x 12 protocols = 48)
